...
Python 3.11 — Framework web : Flask — ORM : SQLAlchemy — Base de données : PostgreSQL — Migrations : Alembic — Sécurité : gestion de mots de passe hashés, utilisation de JWT — Conteneurisation : Docker, Docker Compose — Outils intégrables : Nmap, Hydra, OpenVAS, ZAP, etc. — Structure modulaire pour la scalabilité et l’intégration facile de nouveaux outils.
